...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<div class="container">
			...
			<ul class="navbar-nav">
				<li class="nav-item"><a class="nav-link" href="menu.jsp">Products</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="utilisateur.jsp">Users</a>
				</li>
	...
	<div class="container">
		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<tr>
					...
					<td><%=p.getPrix()%></td>
					<td><%=p.getFour()%></td>
					<td><a href="update.jsp?id=<%=p.getId()%>&nom=<%=p.getId()%>"
						class="btn btn-primary">Update</a> <a
						href="delete.jsp?id=<%=p.getId()%>" class="btn btn-danger">Delete</a>
					</td>
				</tr>
				<%
				}
		...
		<center>
			<a href="res.jsp" class="btn btn-outline-primary btn-lg">Add</a>
		</center>
	</div>
	<script
